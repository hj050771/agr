...
@Table(name = "link_vegetable_supplier")
public class LinkVegetableSupplier extends BaseEntity {
    @Column(name = "ep_id")
    private String epId;
     ...
     * 获取供应商表关联id(即客户表id)
     *
     * @return supplier_id - 供应商表关联id(即客户表id)
     */
     ...
     * 设置供应商表关联id(即客户表id)
     *
     * @param supplierId 供应商表关联id(即客户表id)
     */
